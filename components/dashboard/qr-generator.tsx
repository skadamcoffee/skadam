...
export function QRGenerator() {
  ...
  const generateQR = async () => {
    ...
    try {
      const qrUrl = `${typeof window !== "undefined" ? window.location.origin : ""}/menu?table=${encodeURIComponent(tableNumber.trim())}`
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Create QR codes for your tables that customers can scan to access the menu</CardDescription>
        </CardHeader>
